...
Future <Map<String,dynamic>> registerUser({
  ...
  try{
    final response = await http.post(Uri.parse('$baseUrl/register'),headers:{'Content-Type':'application/json'},body:jsonEncode({
      'name'=>name,
      'email'=>email,
      'password'=>password,
      'role'=>role
    ...
    if(response.statusCode == 201){
      ...
      return {'status': 'error', 'message': 'تعذر الاتصال بالخادم، تحقق من شبكة الإنترنت.'};
    }
