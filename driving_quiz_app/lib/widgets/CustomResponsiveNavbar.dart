...
class CustomResponsiveNavbar extends StatelessWidget implements PreferredSizeWidget {
    ...
    return Padding(
      ...
      child: TextButton(
        style: TextButton.styleFrom(
          foregroundColor: isActive ? AppColors.primaryGreen : AppColors.textPrimary,
        ),
        onPressed: () {
        },
        child: Text(
